                ...
                <div className="w-3/4 ">
                        ...
                        {isExpanded && (
                            <div className="mt-2 pl-10">
                                <p className="text-sm mb-2">
                                    Подбайте про свою безпеку: ніколи не повідомляйте свої персональні дані чи
                                    дані кредитної картки телефоном, електронною поштою чи в повідомленнях.
                                </p>
                                <a
                                    href="#"
                    ...
                    <div className="flex mb-4">
                        <div className="flex-1">
                            <h3 className="text-2xl font-bold text-sky">
                                Hotel Mir <span className="text-yellow-500"></span>
                            </h3>
                            ...
                            <div className="flex justify-between">
                                ...
                                <div className="flex-shrink-0 ml-4">
                                    <img
                                        src="https://r-xx.bstatic.com/xdata/images/hotel/max300/337412736.jpg?k=638f44ce0e26c1710fb463938cfc20a757a2addfa41ddf7f2dd4efca74ae8bae&o="
                                        alt="Hotel"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Link to={""} className="absolute -left-3">
                                            <Button variant="translight" className="text-sky" size="sm">
                                                Показати маршрут
                                            </Button>
                                        </Link>
                                    </div>
                    ...
                    <div className="border border-lightgray/20 rounded-sm p-4 ">
                        <div className="">
                            ...
                            <p className="text-xs mb-2 py-2">
                                Ви завжди можете переглянути або змінити своє бронювання онлайн (реєстрація не
                                pотрібна).
                            </p>
